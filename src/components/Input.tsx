    ...
    return (
        <>
            <div className="mt-4 h-10 w-[100%] flex items-center border border-[rgba(255,255,255,0.08)] text-[#fff] px-[10px] rounded-[10px] gap-[10px] bg-[#0c1427]">
                ...
                <input className={`w-[100%] h-[100%] outline-none border-none pl-2 ${className || ""}`} type={type} {...register} name={name} id={id} placeholder={placeholder} value={value} onChange={onChange} />
            </div>
