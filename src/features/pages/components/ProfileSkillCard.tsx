...
const ProfileSkillCard: FC<CardProps> = ({ icon, skill, skillDesc, techStack }) => {
    return (
        <div className="w-[320px] min-h-[450px] h-auto mr-auto ml-auto mb-8 bg-[rgba(255,255,255,0.03)] border border-[rgba(255,255,255,0.08)]
                     rounded-[20px] shadow-[0_10px_30px_rgba(2,6,23,0.5)] text-center px-6 pb-10 cursor-zoom-in hover:scale-y-110 hover:scale-x-105 transition-transform duration-200">
